...
public class ChangelogResource {
    ...
    @Inject
    public ChangelogResource(final ChangelogService service) {
        this.service = service;
    }

    @POST
    @Path("/systems/{systemId}/changelogs")
    public void postChangelog(@PathParam("systemId") final String id, @Valid final List<ChangelogDto> changelogs)
            throws ConstraintViolationException {
        this.service.addChangelogs(id, changelogs);
    }
}
